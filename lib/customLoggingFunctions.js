...
function backupAndClearCurrentLog(log, getState, setState, formatDate, writeFile, sendTo) {
    saveCurrentLogToFile(log, getState, setState, formatDate, writeFile, sendTo, wasSuccessful => { if (wasSuccessful) clearCurrentLog(setState); });
}
...
function saveCurrentLogToFile(log, getState, setState, formatDate, writeFile, sendTo, cb) {
