...
function setThermostatMode(log, existsState, getState, setState, compareTime, room, mode) {
    ...
    switch (mode) {
        ...
        case THERMOSTAT_MODES.MANUAL:
            ...
            break;
        // Simulation des CLOSED Modus: Modus auf "MANUAL", WINDOW_STATE auf "OPEN" und Solltemperatur auf 5°C setzen
        case THERMOSTAT_MODES.CLOSED:
            ...
            setTimeout(() => { setThermostatTargetTemperature(getState, setState, room, minThermostatTargetTemp); }, 500);
            break;
    }
}
