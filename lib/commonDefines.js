...
const BUTTON_EVENTS_NAMES = {
    SINGLE_PRESS: "BUTTON_IS_RELEASED_AFTER_PRESS",
    DOUBLE_PRESS: "BUTTON_IS_DOUBLE_PRESS",
    HOLD: "BUTTON_IS_HOLD",
    HOLD_RELEASE: "BUTTON_IS_RELEASED_AFTER_HOLD"
};
...
const ROOMS_WITH_MOTION_SENSOR = [ROOMS.GANG, ROOMS.KUECHE];
...
module.exports = {
    STATES, BUTTON_EVENTS, BUTTON_EVENTS_NAMES, DAYTIMES, ROOMS, ROOMS_EN, ROOMS_WITH_DOOR, ROOMS_WITH_WINDOW, ROOMS_WITH_MOTION_SENSOR, ROOMS_WITH_AIR_CONDITIONING,
    ROOMS_WITH_AIR_CONDITIONING_EN, ROOMS_WITH_AIR_PURIFIER, ROOMS_WITH_THERMOSTAT, ROOMS_WITH_THERMOSTAT_EN, ROOMS_WITH_LIGHTING, idUserDataPrefix
};