...
var presenceFunctions = require("/opt/iobroker/iobroker-data/modules/presenceFunctions.js");
...
const ECHO_DEVICES = {
    ...
    WOHNZIMMER_FIRE_TV: "G0723H0724130AMW",
...
const allEchoDevices = [ECHO_DEVICES.FLUR, ECHO_DEVICES.KUECHE, ECHO_DEVICES.WOHNZIMMER_FIRE_TV];
...
*/
function outputToAlexa(getState, setState, text, voiceOutput, pushOutput, echoDeviceId = ECHO_DEVICES.FLUR, overrideDND = false, overrideVolume = 50) {
    if (text == "") return;
...
* @param {number} [overrideVolume] Temporäre Lautstärke, falls DND ignoriert wird (default = 50)
*/
function outputToEchoDot(getState, setState, voiceText, echoDeviceId = ECHO_DEVICES.FLUR, overrideDND = false, overrideVolume = 50) {
...
module.exports = {
    ECHO_DEVICES, ECHO_CURATED_TTS_TYPES, allEchoDevices, changeAlexaPlayerVolume, setAlexaDND, getAlexaDND,
    triggerAlexaCuratedTTS, pauseAlexaPlayer, startAlexaPlayer, getAlexaPlayerCurrentTitle, getAlexaPlayerCurrentProviderId,
    getAlexaPlayerCurrentState, outputToAlexa, outputToEchoDot, outputToAlexaApp
};