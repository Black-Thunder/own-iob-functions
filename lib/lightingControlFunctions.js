...
function invertAmbientLightsState(
	...
	isOn
		...
		: powerAmbientLightsOn($, log, getState, setState, getObject, existsState, clearStateDelayed, room, isNight);
}
...
function powerAmbientLightsOn($, log, getState, setState, getObject, existsState, clearStateDelayed, room, isNight) {
	...
	ambientLightIds.forEach(ambientLightId => {
		setTimeout(() => {
			const desiredBrightnessAmbient = getLightDefaultBrightnessLevel(
				getObject,
				existsState,
				ambientLightId,
				false,
...
function invertMainLightsState(
	...
	isOn
		...
		: powerMainLightsOn($, log, getState, setState, getObject, existsState, clearStateDelayed, room, isNight);
}
