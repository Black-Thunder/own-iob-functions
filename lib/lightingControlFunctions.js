...
function invertAmbientLightsState($, log, getState, setState, setStateDelayed, getObject, existsState, clearStateDelayed, room, isNight) {
    ...
    ambientOnArray[0][1] ? powerAmbientLightsOff($, log, getState, setState, setStateDelayed, getObject, room) : powerAmbientLightsOn($, log, getState, setState, getObject, existsState, clearStateDelayed, room, isNight);
}
...
function invertMainLightsState($, log, getState, setState, setStateDelayed, getObject, existsState, clearStateDelayed, room, isNight) {
    ...
    // Immer auf das erste Element gehen und diesen Zustand auswerten
    mainOnArray[0][1] ? powerMainLightsOff($, log, getState, setState, setStateDelayed, getObject, room) : powerMainLightsOn($, log, getState, setState, getObject, existsState, clearStateDelayed, room, isNight);
}
