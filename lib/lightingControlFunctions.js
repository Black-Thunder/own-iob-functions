...
* @param {string} room via Rooms
*/
function invertAmbientLightsState(log, getState, setState, setStateDelayed, getObject, existsState, room, isNight) {
    ...
    ambientOnArray[0][1] ? powerAmbientLightsOff(log, getState, setStateDelayed, getObject, room) : powerAmbientLightsOn(log, getState, setState, getObject, existsState, room, isNight);
}
...
*/
function powerAmbientLightsOn(log, getState, setState, getObject, existsState, room, isNight) {
...
* @param {string} room via Rooms
*/
function invertMainLightsState(log, getState, setState, setStateDelayed, getObject, existsState, room, isNight) {
    const mainOnArray = getMainLightStates(log, getState, getObject, room);

    if (!mainOnArray || mainOnArray.length == 0) return false;

    // Immer auf das erste Element gehen und diesen Zustand auswerten
    mainOnArray[0][1] ? powerMainLightsOff(log, getState, setStateDelayed, getObject, room) : powerMainLightsOn(log, getState, setState, getObject, existsState, room, isNight);
}
...
*/
function powerMainLightsOn(log, getState, setState, getObject, existsState, room, isNight) {
    // Zuerst prüfen, ob es eine passende Phoscon-Gruppe gibt, über die man schalten kann -> nur ein Befehl statt x-Einzelbefehlen
